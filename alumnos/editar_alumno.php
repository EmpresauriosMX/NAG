...
$qry2 = mysqli_query($link,"select * from alumnos where ID_Usuario = '$us'")
or die("Failed to query database".mysql_error());
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h1 class="m-0 text-dark">Editar datos de alumno</h1>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="card card-primary">
              ...
              <?php
     echo         '<form action="../php/edalumno.php" method="post">
				...
				<div class="form-group">
                    ...
                    <input readonly type="text" class="form-control" value="'.$row2['Matricula'].'" required="required" placeholder="Matricula">
                  </div>
				  ...
				  <div class="form-group">
                    <label for="ap">Nombre de tutor</label>
                    <input type="text" class="form-control" value="'.$row2['NombreTutor'].'" id="nt" name="nt" required="required" placeholder="Escribe el Apellido Materno">
                  </div>
