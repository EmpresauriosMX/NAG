...
<table id="example2" class="table table-bordered table-hover">
  ...
  <table align="center">
    <tr>
      <td><a href="../docente/subir_calificacion_2.php"><button type="button" class="btn btn-block btn-danger btn-lg">cancelar</button></a></td>
      <td><a href="../docente/subir_calificacion_2.php"><button type="button" class="btn btn-block success btn-lg">calificar</button></a></td>
      <td><a href="../docente/subir_calificacion_2.php"><button type="button" class="btn btn-block btn-info btn-lg">imprimir</button></a></td>
    </tr>
</div>
