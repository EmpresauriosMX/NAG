          ...
          <div class="col-md-8">
            <div class="card">
              ...
              <div class="card-body">
               ...
               <!--inicio calendario-->
               <img src="../img/calendario.png" width="67%">
                  </div>
                   <!--fin calendario-->
                  <!-- /.tab-pane -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td>6:00 - 7:00</td>
                    <td>enfermeria 5B <br> matematicas</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td>enfermeria 4B <br> matematicas</td>
                    <td></td>
                    <td></td>
                  ...
                  <tr>
                    <td>12:30 - 13:30</td>
                    <td>Administracion C<br> contabilidad</td>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td></td>
              ...
              <div class="card-body">
                <ul class="todo-list" data-widget="todo-list">
                  <li>
                    ...
                    <!-- todo text -->
                    <span class="text">subir calificacion de "x"</span>
                    <!-- Emphasis label -->
                  ...
                  <li>
                    ...
                    <span class="text">crear una nueva tarea</span>
